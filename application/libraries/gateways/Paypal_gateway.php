...
class Paypal_gateway
{
    ...
    public function process_payment($data)
    {
        ...
        $request_data = array(
            'amount' => number_format($data['amount'], get_decimal_places(), '.', ''),
        ...
        try {
            ...
            if ($response->isRedirect()) {
                $this->ci->session->set_userdata(array(
                    'online_payment_amount' => number_format($data['amount'], get_decimal_places(), '.', ''),
                    'currency' => $data['invoice']->currency_name,
                    ));
    ...
    public function get_setting_value($name){
        ...
        return isset($this->settings_values[$name]) ? $this->settings_values[$name] : '';
    }
