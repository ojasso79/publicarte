...
function render_admin_js_variables()
{
    ...
    $lang        = do_action('before_render_app_js_lang', $lang);
...
function show_pdf_unable_to_get_image_size_error(){
   ...
   <hr />
    ...
    <p>Very often this is happening <b>when you are using custom PDF logo url in Setup -> Settings -> PDF</b>, to fix this you need to use <b>direct path</b> to the image to include in the PDF document. Follow the steps mentioned below:</p>
