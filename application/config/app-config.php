...
define('APP_BASE_URL','http://localhost:8888/publicarte/');
...
define('APP_ENC_KEY','2f7490b70f824587f4a29f876550c5b8');
...
define('APP_DB_USERNAME','publicarte_u');
/* The password used to connect to the database */
define('APP_DB_PASSWORD','Xku-3628');
/* The name of the database you want to connect to */
define('APP_DB_NAME','publicarte');
