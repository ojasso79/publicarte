...
$(function() {
    ...
    _table_api = initDataTable('.table-tickets-single', admin_url + 'tickets/index/""/' + customer_id, [ticketsNotSortable], [ticketsNotSortable], 'undefined', [$('table thead .ticket_created_column').index(), 'DESC'])
    if (_table_api) {
