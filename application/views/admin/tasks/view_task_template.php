<div class="modal-header" data-task-single-id="<?php echo $task->id; ?>" data-status="<?php echo $task->status; ?>">
...
?>
   ...
   <br />
   <?php } ?>
   <?php if($task->addedfrom != 0 && $task->addedfrom != get_staff_user_id()){ ?>
      <small><?php echo _l('task_created_by',get_staff_full_name($task->addedfrom)); ?></small>
   <?php } ?>
   ...
   <div class="row">
      <div class="col-md-8 task-single-col-left">
         ...
         <p class="no-margin pull-left" style="margin-right:5px !important;">
            <a href="#" class="btn btn-info" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="mark_complete(<?php echo $task->id; ?>); return false;" data-toggle="tooltip" title="<?php echo _l('task_single_mark_as_complete'); ?>">
            <i class="fa fa-check"></i>
            </a>
         </p>
         <?php } else if($task->status == 5){ ?>
         <p class="no-margin pull-left" style="margin-right:5px !important;">
            <a href="#" class="btn btn-default" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="unmark_complete(<?php echo $task->id; ?>); return false;" data-toggle="tooltip" title="<?php echo _l('task_unmark_as_complete'); ?>">
            <i class="fa fa-check"></i>
            </a>
         </p>
         <?php } ?>
