<div class="panel_s accounting-template estimate">
         ...
         <div class="col-md-6">
            ...
            <div class="f_client_id">
             <div class="form-group">
                ...
                <select id="clientid" name="clientid" data-live-search="true" data-width="100%" class="ajax-search" data-none-selected-text="Nada seleccionado">
         ...
         <div class="col-md-6">
            <div class="panel_s" style="display:none">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12">
                      <!-- aqui va el control del empleado de ventas-->
                     <div class="form-group">
   ...
   <?php $this->load->view('admin/estimates/my_add_edit_items'); ?>
   <div class="row">
