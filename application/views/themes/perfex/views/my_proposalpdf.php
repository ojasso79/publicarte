...
$proposal_date = 'Fecha: ' . _d($proposal->date);
$open_till = '';
if(!empty($proposal->open_till)){
    $open_till = 'Válida hasta: ' . _d($proposal->open_till);
}
$custom_fields_data = '';
...
<tr height="30" bgcolor="'.get_option('pdf_table_heading_color').'" style="color:'.get_option('pdf_table_heading_text_color').';">
    ...
    <th width="'.$item_width.'%" align="left">Artículo</th>
    <th width="12%" align="right">Cantidad</th>
    <th width="15%" align="right">Precio</th>';
    if(get_option('show_tax_per_item') == 1){
        $items_html .= '<th width="15%" align="right">IVA</th>';
    }
    $items_html .='<th width="15%" align="right">Monto</th>
</tr>';
